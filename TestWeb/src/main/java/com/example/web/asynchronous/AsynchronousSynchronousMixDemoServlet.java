...
/**
 * Servlet implementation class AsynchronousSynchronousMixDemoServlet
 */
public class AsynchronousSynchronousMixDemoServlet extends HttpServlet {
   ...
   protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		LOGGER.info("Inside AsynchronousSynchronousMixDemoServlet.doGet() ... entered");
		...
		if(null != asynchronousDemoBean) {
			...
			asynchronousDemoBean.processPayment2(request.getParameter("debitCardNo"), request.getParameter("cvv"), request.getParameter("name"));
		}
		else {
		...
		LOGGER.info("Inside AsynchronousSynchronousMixDemoServlet.doGet() ... leavig");
   }
